...
export function WeatherCard({ data }: Props) {
  ...
  function getDescription(data: WeatherInfo["weather"]) {
    ...
    return (
      weatherDescriptions[
        data[0].description as keyof typeof weatherDescriptions
  ...
  return (
    <Card className="absolute z-[1000] left-3 top-3 w-full max-w-sm md:max-w-lg shadow-md animate-show-up">
      <CardHeader>
        <CardTitle>
          <Image src={url} alt="weather icon" width={40} height={40} />
        </CardTitle>
        <CardDescription
          className="font-rmono text-sm"
          ...
          <div className="grid grid-cols-2">
            <div>
              ...
              <p
                ...
                className="font-rmono text-sm text-title"
              >
                {data.main.humidity}
              </p>
            </div>
            <div>
              ...
              <p className="font-rmono text-sm text-title">
                {data.main.humidity}
              </p>
            </div>
          </div>
